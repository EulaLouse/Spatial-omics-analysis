...
dir = c('spaceranger/S1/outs','spaceranger/S2/outs','spaceranger/S3/outs','spaceranger/S4/outs')
...
seurat_ob <- merge(seu_list[[1]], y=c(seu_list[[2]], seu_list[[3]], seu_list[[4]]))
...
ggsave("topmarker_gene_heatmap.png")


# Diffexp
res = Seurat::FindMarkers(seurat_ob, ident.1 = "S1",
                          ident.2 = "S2",
                          group.by = "sampleid",
                          test.use = "MAST",
                          only.pos = F )
